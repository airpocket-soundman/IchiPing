...
![デモシナリオ全体図](docs/img/demo_use_case.svg)
...
**1 個のマイクと 1 発の Ping (能動音響) だけで、家中の窓・扉 32 通りの組合せ状態を一発推定する** エッジ AI デバイス。これに **降雨センサ + ESP32** をデモ用周辺機器として追加することで、次のフローが成立する:
...
| スマートホーム連携 | クラウド (Home Assistant / 任意の MQTT broker) | ESP32 から push、スマホアプリで受信 |
