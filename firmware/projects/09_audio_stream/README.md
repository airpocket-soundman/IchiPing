...
[06_mic_test](../06_mic_test/README.md) と完全に同じ（**マイクのみ**, SAI1 TX-master + RX-sync）。**J1.1 SCK / J1.11 WS / J1.15 SD**、すべて FRDM-MCXN947 出荷時のジャンパ位置 (SJ11=1-2, SJ10=1-2) のままで動く。スピーカ (MAX98357A) は接続不要。
