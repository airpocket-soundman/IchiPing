 ...
 *
 * 10_inference — SAI1 (audio) + LPSPI1 (ILI9341) + on-board SW3.
 */
#ifndef _APP_H_
#define _APP_H_
...
#define BOARD_ILI_CS_PIN           14U
#define BOARD_ILI_RES_GPIO         GPIO0
#define BOARD_ILI_RES_PIN          22U
#define BOARD_ILI_DC_GPIO          GPIO0
#define BOARD_ILI_DC_PIN           15U
#define BOARD_ILI_BL_GPIO          GPIO0
#define BOARD_ILI_BL_PIN           23U
